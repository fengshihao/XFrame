...
public class XFrameLint extends Detector {
  public static final Issue ISSUE = Issue.create("LogUtilsNotUsed",
      ...
      "Logging should be avoided in production for security and performance reasons. " +
          "Therefore, we created a LogUtils that wraps all our calls to Logger and disable them for release flavor.",
      Category.MESSAGES,
      9,
      Severity.ERROR,
      new Implementation(XFrameLint.class,
